...
gotaland <- gUnaryUnion(gotaland_c)
...
# gotaland_grid25 <- gIntersection(spTransform(Sweden_Grid_25km_Wgs84, CRSobj = CRS(sf::st_crs(4326)$wkt)), 
#                                  gotaland, 
#                                  byid = TRUE)
...
plot(SB$spatial, col=SB$spatial$nObs)
