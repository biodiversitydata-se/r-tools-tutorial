...
Despite the drop seen in sampling effort <span class=hgl>(IF DATA IS NOT CHANGED)</span>, we can still analyse weather there is any trends for species over the 20 yrs?:
